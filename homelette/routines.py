...
__all__ = [
    "Routine_automodel_default",
    "Routine_automodel_slow",
    "Routine_altmod_default",
    "Routine_altmod_slow",
    "Routine_promod3",
    "Routine_loopmodel_default",
    "Routine_loopmodel_slow",
...
class Routine_modeller(Routine):
    ...
    def _generate_models(
        self,
        model_class: typing.Type["modeller.automodel.automodel"],
        n_models: int,
        library_schedule: typing.Type["modeller.schedule.schedule"],
        max_var_iterations: int,
        md_level: typing.Callable,
        repeat_optimization: int,
        n_threads: int,
        use_hetatms: bool = False,
    ) -> None:
        """
        ...
        for pdb in glob.glob("{}.B99*.pdb".format(self.target)):
            self.models.append(
                Model(
                    os.path.realpath(os.path.expanduser(pdb)),
                    self.tag,
                    self.routine,
                )
            )
...
class Routine_promod3(Routine):
    ...
    def __init__(
        ...
        if len(templates) != 1:
            raise ValueError(
                "ProMod3 only accepts one template structure, "
    ...
    def generate_models(self) -> None:
        ...
        self.models.append(
            Model(
                os.path.realpath(os.path.expanduser(("model.pdb"))),
                self.tag,
                self.routine,
            )
        )
...
class Routine_loopmodel(Routine_modeller):
    ...
    def _generate_models(
        ...
        md_level: typing.Callable,
        repeat_optimization: int,
        loop_library_schedule: typing.Type["modeller.schedule.schedule"],
        loop_max_var_iterations: int,
        loop_md_level: typing.Callable,
        n_threads: int,
        use_hetatms: bool = False,
    ) -> None:
        """
...
class Routine_loopmodel_default(Routine_loopmodel):
    ...
    * n_loop_models
    ...
    def __init__(
        ...
        templates: typing.Iterable,
        tag: str,
        loop_selections: typing.Iterable,
        n_models: int = 1,
        n_loop_models: int = 1,
    ) -> None:
        # init parameters
    ...
    class _AutomodelComplex(modeller.automodel.automodel):
        ...
        def special_patches(self, aln):
            ...
            self.rename_segments(
                segment_ids=segment_ids, renumber_residues=renumber_residues
            )
